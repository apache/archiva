...
public class RedbackImplementationsInformations
{
    ...
    public String toString()
    {
        ...
        sb.append( "{userManagerImplementationInformations=" ).append( userManagerImplementationInformations );
        sb.append( ", rbacManagerImplementationInformations=" ).append( rbacManagerImplementationInformations );
        sb.append( '}' );
        return sb.toString();
    }
}
